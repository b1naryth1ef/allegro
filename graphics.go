...
func (b *Bitmap) LockRegion(x, y, width, height, format, flags int) *LockedRegion {
...
func (b *Bitmap) GetFlags() int {
	return int(C.al_get_bitmap_flags(b.allegroBitmap))
}

func (b *Bitmap) GetFormat() int {
...
func (b *Bitmap) DrawTinted(tint *Color, dx, dy float32, flags int) {
...
func (b *Bitmap) DrawTintedRegion(tint *Color, sx, sy, sw, sh, dx, dy float32, flags int) {
...
func (b *Bitmap) DrawTintedRotated(c *Color, cx, cy, dx, dy, angle float32, flags int) {
...
func (b *Bitmap) DrawTintedScaledRotated(c *Color, cx, cy, dx, dy, xscale, yscale, angle float32, flags int) {
...
func (b *Bitmap) DrawScaled(sx, sy, sw, sh, dx, dy, dw, dh float32, flags int) {
...
func (b *Bitmap) DrawTintedScaled(c *Color, sx, sy, sw, sh, dx, dy, dw, dh float32, flags int) {
...
func LoadBitmapF(fp *File, ident string) *Bitmap {
	...
	return &Bitmap{C.al_load_bitmap_f(fp.allegroFile, i)}
}

func (b *Bitmap) Save(fileName string) bool {
	f := C.CString(fileName)
	defer C.free(unsafe.Pointer(f))
	return bool(C.al_save_bitmap(f, b.allegroBitmap))
}

func (b *Bitmap) SaveF(fp *File, ident string) bool {
	i := C.CString(ident)
	defer C.free(unsafe.Pointer(i))
	return bool(C.al_save_bitmap_f(fp.allegroFile, i, b.allegroBitmap))
}
